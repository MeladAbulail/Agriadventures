  ...
  return (
    <section>
      <div className="flex items-stretch min-h-screen   bg-[#fcf9f3]">
        ...
        <div className="w-full h-full px-6 py-10 mx-auto my-auto lg:w-1/2">

          <div className="max-w-md mx-auto mt-10 ">

            <h2 className="mb-8 text-3xl font-bold text-[#224229]">Register Account</h2>
            ...
            <select
              ...
              onChange={handleInputChange}
              className="w-full px-3 py-2 mt-2 text-[#224229] bg-white border rounded-lg shadow-sm outline-none focus:border-[#224229]"
            >
              ...
              <Link to="/Signin"><div className="flex items-center justify-between mt-6">
                <p className='text-[#224229]  '>Already have an account ? <span className='text-[#224229] hover:text-[#314534]'>Sign in!</span></p>
              </div></Link>
