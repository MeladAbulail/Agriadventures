        ...
        <footer class="bg-[#F2F5F8] text-center text-black  lg:text-left mt-auto ">
          ...
          <div class="mx-6 py-10 text-center md:text-left">
            <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div class="">
                <h6 class="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start text-[#80B500]">
                  Agriadventure
                </h6>
                <p>
              ...
              <div>
                ...
                <p class="mb-4 flex items-center justify-center md:justify-start hover:text-[#80B500]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                ...
                <p class="flex items-center justify-center md:justify-start hover:text-[#80B500]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
